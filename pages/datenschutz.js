...
const DatenschutzPage = () => {
  return (
    <section className="max-w-4xl xl:mx-auto px-6">
      ...
      <h2 id="m14" className="font-bold text-xl mb-2">
        Einleitung
      </h2>
      <p>
      ...
      <h2 className="font-bold text-xl my-2">Inhaltsübersicht</h2>{' '}
      <ul class="index">
        <li>
      ...
      <h2 id="m3" className="font-bold text-xl my-2">
        Verantwortlicher
      </h2>
      <p>
        Nader el Sayed
      ...
      E-Mail-Adresse:{' '}
      <p>
        <a href="mailto:nels@tuta.io">nels@tuta.io</a>
      </p>
      <h2 id="mOverview" className="font-bold text-xl my-2">
        Übersicht der Verarbeitungen
      </h2>
      <p>
      ...
      <h3 className="font-bold text-lg my-2">Arten der verarbeiteten Daten</h3>
      <ul>
        <li>Bestandsdaten.</li>
        <li>Kontaktdaten.</li>
        <li>Inhaltsdaten.</li>
      ...
      <h3 className="font-bold text-lg my-2">Zwecke der Verarbeitung</h3>
      <ul>
      ...
      <h3 id="m13" className="font-bold text-lg my-2">
        Maßgebliche Rechtsgrundlagen
      </h3>
      <p>
      ...
      <h2 id="m27" className="font-bold text-xl my-2">
        Sicherheitsmaßnahmen
      </h2>
      <p>
      ...
      <h2 id="m25" className="font-bold text-xl my-2">
        Übermittlung von personenbezogenen Daten
      </h2>
      <p>
      ...
      <h2 id="m24" className="font-bold text-xl my-2">
        Datenverarbeitung in Drittländern
      </h2>
      <p>
      ...
      <h2 id="m12" className="font-bold text-xl my-2">
        Löschung von Daten
      </h2>
      <p>
      ...
      <h2 id="m134" className="font-bold text-xl my-2">
        Einsatz von Cookies
      </h2>
      <p>
      ...
      <h2 id="m225" className="font-bold text-xl my-2">
        Bereitstellung des Onlineangebotes und Webhosting
      </h2>
      <p>
      ...
      <h2 id="m367" className="font-bold text-xl my-2">
        Registrierung, Anmeldung und Nutzerkonto
      </h2>
      <p>
      ...
      <h2 id="m182" className="font-bold text-xl my-2">
        Kontakt- und Anfragenverwaltung
      </h2>
      <p>
      ...
      <h2 id="m15" className="font-bold text-xl my-2">
        Änderung und Aktualisierung der Datenschutzerklärung
      </h2>
      <p>
      ...
      <h2 id="m10" className="font-bold text-xl my-2">
        Rechte der betroffenen Personen
      </h2>
      <p>
